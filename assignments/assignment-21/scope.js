...
// area = length * width;
// console.log(`The area of the rectangle is now ${area}`);// Output TypeError: Assignment to constant variable.
...
console.log(myFunctionDeclaration()); // This is function declaration!

function myFunctionDeclaration() {
    return "This is a function declaration!";
}

console.log(myFunctionExpression()); // This is not a function
...
function someFunction() {
    ...
    if (true) {
        ...
        console.log(myVar); // Output:I'm in block scope.
    }

    console.log(myVar); //Output: I'm in function scope!.
}
